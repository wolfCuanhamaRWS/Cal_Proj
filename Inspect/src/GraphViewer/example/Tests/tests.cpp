...
TEST(Inspect, test_floydWarshall) {
    Graph<int> myGraph = CreateTestGraph();
    myGraph.floydWarshallShortestPath(0.001);
...
TEST(Inspect, test_searchNearestAgEconoTmpViagem){
    ...
    loadGraphNodesInfo(gr,"../resources/graphs/GridGraphs/4x4/nodes.txt", "../resources/graphs/GridGraphs/4x4/nodes.txt","../resources/graphs/GridGraphs/4x4/edges.txt",40.0);
...
TEST(Inspect, GrafoTest) {
    Graph<int> graph;
    //id, h_t, h_i, A_E

    AgenteEconomico ag1(1, Obras, 50, make_pair(9, 19), new Denuncias(3, 5), new Inspecoes(10, 1),
                        new Data(2019, 12, 11), 2);
    AgenteEconomico ag2(2, Obras, 50, make_pair(9, 19), new Denuncias(4, 5), new Inspecoes(11, 1),
                        new Data(2019, 12, 11), 14);
    AgenteEconomico ag3(3, Obras, 50, make_pair(9, 19), new Denuncias(2, 5), new Inspecoes(9, 2),
                        new Data(2019, 12, 10), 22);
    ...
    loadGraphNodesInfo(graph, "../src/Mapas/PortoTeste/porto_strong_nodes_xy.txt", "../src/Mapas/PortoTeste/porto_strong_nodes_latlng.txt",
                       "../src/Mapas/PortoTeste/porto_strong_edges.txt", 40.0);
    ...
    //TEste ao dijkstra e como funciona
    graph.floydWarshallShortestPath();
    vector<int> aux = graph.getfloydWarshallPath(3,11);
    stringstream ss;
