...
int main() {
    ...
    loadGraphNodesInfo(gr, "../resources/graphs/PortoTeste/EspinhoTeste/espinho_full_nodes_xy.txt",
    ...
    Graph<int> gr2;
    //mainMenu(AtPub);
    loadGraphNodesInfo(gr2, "../resources/graphs/PortoTeste/EspinhoTeste/espinho_strong_nodes_xy.txt",
