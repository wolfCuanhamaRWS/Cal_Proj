...
public:
        ...
        AutoridadePublica(string ficheiroAgEcono,string ficheiroBrig);
 ...
 */
     ...
     */
    unordered_map<unsigned int, AgenteEconomico *> processarFicheiroAgentes(string ficheiro);

    /**
     * Função que lê a informação do ficheiro brigadas.txt e processa essa informação
     * @return mapa desordenado com as brigadas
     */
    unordered_map<unsigned int, Brigada *> processarFicheiroBrigadas(string ficheiro);
