...
public:
	 ...
	 * Exemplo: INSPECT_IT *gv = new INSPECT_IT(600, 600, true); instancia um grafo
	 ...
	 *
	 * Exemplo: INSPECT_IT *gv = new INSPECT_IT(600, 600, false, 3000); instancia um grafo
	 ...
	 * Exemplo, para um apontador gv onde foi instanciada a classe INSPECT_IT:
	 ...
	 * for dinâmico.
	 * Exemplo, para um apontador gv onde foi instanciada a classe INSPECT_IT com isDynamic = false:
	 ...
	 * Exemplo, para um apontador gv onde foi instanciada a classe INSPECT_IT com isDynamic = true:
